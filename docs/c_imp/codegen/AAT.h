...
struct AATstatement_ {
  enum {AAT_MOVE, AAT_JUMP, AAT_CONDITIONALJUMP, AAT_CALLSTATEMENT, 
        AAT_SEQ, AAT_EMPTY, AAT_LABEL, AAT_RETURN, AAT_HALT} kind;  
  union {
    struct {
      AATexpression lhs;
      AATexpression rhs;
...
struct AATexpression_ {
  enum {AAT_MEMORY, AAT_OPERATOR, AAT_CALLEXPRESSION, AAT_CONSTANT, AAT_REGISTER} kind;
  union {
